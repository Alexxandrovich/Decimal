...
START_TEST(test_s21_is_less_8) {
  ...
  s21_decimal dec6 = {{12, 0, 0, 0x80010000}};  // -1.2
  ...
  s21_decimal dec8 = {{12, 0, 0, 0x10000}};        //  1.2;
  ...
  s21_decimal dec2 = {{12, 0, 0, 0x10000}};     //  1.2;
  ...
  s21_decimal dec4 = {{12, 0, 0, 0x80010000}};     //  -1.2;
...
START_TEST(test_s21_is_less_9) {
  ...
  ck_assert_int_eq(0, s21_is_less(a1, a2));
}
END_TEST
...
Suite* s21_is_less_test(void) {
  Suite* s;
  TCase* tc_core;
  s = suite_create("\033[97m\033[106ms21_is_less_test\033[0m");
